			...
			<div class="container">
				<div class="row">
					<div class="cont-info right my-auto col-sm-12 col-md-6">						
						...
						<p class="p-1">Creá las categorías de tus productos y
							cargá las imágenes y precios que verán tus clientes al escanear tu QR,
			...
			<div class="row cont-all-precios">
				...
				<div class="item ez-animate active selected col-md-4" data-animation="fadeInUp">					
					...
					<ul>
						...
						<li style="text-decoration:line-through">Soporte gratuito 24/7</li>
					</ul>
	...
	<div id="section-footer">
		...
		<div class="footer-copyright container-fluid ">
			<div class="col-12">
				<p>© 2019 Copyrights <a href="https://themeforest.net/user/puricreative/portfolio">Marcos E. Dituri</a></p>
			</div>
		</div>
	</div>
	<!-- /.Section Footer -->
